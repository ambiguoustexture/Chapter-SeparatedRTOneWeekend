...
color ray_color(const ray& r, const hittable& world, int recursion_depth) 
{
    ...
    if (world.hit(r, 0.001, infinity, rec)) {
        ...
        // return 0.5 * 
        //     ray_color(ray(rec.p, target - rec.p), world, recursion_depth - 1);
...
int main() 
{
    ...
    // Fuzzy Reflection
    // We can also randomize the reflected direction 
    // by using a small sphere and choosing a new endpoint for the ray
    // fuzz(f < 1 ? f : 1), 
